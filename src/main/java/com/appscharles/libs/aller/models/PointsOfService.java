...
import com.appscharles.libs.aller.models.pointsOfService.OpenHour;
import com.appscharles.libs.aller.models.pointsOfService.Payment;
...
public class PointsOfService {
     ...
     */
    public PointsOfService(String name, Seller seller, Type type, Address address, ConfirmationType confirmationType, Status status) {
        this.name = name;
        this.seller = seller;
        this.type = type;
